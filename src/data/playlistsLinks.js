const playlists = [
  ...
  },
  {
    ...
    image: "noart.png",
    description:
      "From ghost cities, claustrophobic discotheque rooms, the north me soul remarks the start of the next 40 years of European music and pop scene’s golden mafia. Fast and refreshing chords were now hiding the saddest lyrics with full or trebles guitars, reggae chanks, and Motown like rhythm.",
    tags: ["disco", "historical", "various artists"],
    artists: "",
  },
  {
